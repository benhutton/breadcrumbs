...
Changed breadcrumb method to accept 3 options: <tt>:tag</tt>, 
...
* <tt>:no_link</tt> - The default behavior (if this is set to nil) is to link every breadcrumb EXCEPT for the current page. If this is set to "last", every breadcrumb is linked except the last one.
